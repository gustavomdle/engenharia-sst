...
export default class SstListarProjectsPorStatus extends React.Component<ISstListarProjectsPorStatusProps, IShowEmployeeStates> {

  constructor(props: ISstListarProjectsPorStatusProps) {
    super(props);
    this.state = {
      itemsList: []
    }
